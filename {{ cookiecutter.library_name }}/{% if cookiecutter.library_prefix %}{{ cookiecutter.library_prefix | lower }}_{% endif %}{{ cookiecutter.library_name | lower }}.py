...
__repo__ = "https://github.com/{{ cookiecutter.github_user }}/{% if cookiecutter.library_prefix %}{{ cookiecutter.library_prefix | lower}}_{% endif %}CircuitPython_{{ cookiecutter.library_name }}.git"
